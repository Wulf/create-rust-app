        ...
        None => {
            if !cli_mode {
                ...
                let items = vec![
                    ...
                    "Storage Plugin: adds S3 file storage capabilities", // 1
                    "GraphQL Plugin: bootstraps a GraphQL setup including a playground", // 2
                    "Utoipa Plugin: Autogenerated OpenAPI documentation served in a SwaggerUI playground", // 3
                ];
                ...
                let add_plugin_graphql = chosen.iter().any(|x| *x == 3);
                let add_plugin_utoipa = chosen.iter().any(|x| *x == 4);
